...
public final class XmlExtensionLoaderDelegate {
  ...
  private Optional<ComponentAst> getTestConnectionGlobalElement(List<ComponentAst> globalComponentsAst) {
    ...
    Optional<ComponentAst> testConnectionComponentAst = markedAsTestConnectionGlobalElements.stream().findFirst();
    if (!testConnectionComponentAst.isPresent()) {
      testConnectionComponentAst = findTestConnectionGlobalElementFrom(globalComponentsAst);
    }
    return testConnectionComponentAst;
  }
  ...
  private Optional<ComponentAst> findTestConnectionGlobalElementFrom(List<ComponentAst> globalComponentsAst) {
    ...
    for (ComponentAst globalComponentAst : globalComponentsAst) {
      ...
      if (connectionProviderAst.isPresent()) {
